...
function Sobre() {
  return (
        <Row>
          <p  style={{marginTop:'3vh',marginLeft:"4vh",textIndent:"2vh",textAlign:"justify",width:"100vh",alignItems:'center'}}>
        ...
        <p  style={{marginLeft:"4vh",textIndent:"2vh",textAlign:"justify",width:"100vh",alignItems:'center'}}>
